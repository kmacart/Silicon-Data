 ...
 * If you must, you can also set the volume: "new Thread(new Tone(int hz, int msecs, double vol)).start()", 
 ...
 * It also flicked method-specific errors up-the-chain (don't you hate that?).
